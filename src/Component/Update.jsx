...
function Update(){
    let data={name,price,sellingprice,salescount,imageurl}
   const id= JSON.parse(window.localStorage.getItem("st"))
   fetch(`http://localhost:3000/products/${id}`,{
    method:"PUT",
   headers:{
    ...
    return(
      ...
      Image:<br/><input type="text" class="a" placeholder="" value={imageurl} onChange={(e)=>setImg(e.target.value)}/><br/>
